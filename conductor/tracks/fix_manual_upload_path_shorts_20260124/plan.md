...
- [~] Task: Create a reproduction test case in `tests/test_manual_upload.py` (or a new test file) that simulates an upload attempt for a file in the `shorts/` directory.
