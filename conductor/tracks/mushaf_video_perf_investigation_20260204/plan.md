...
- [x] Task: Integrate basic timing instrumentation around key blocks in `mushaf_video.py` and `single_clip.py`. [ad74fe2]
...
- [x] Task: Monitor and record CPU/GPU/Memory utilization during a full video generation run using system tools. [1359376]
